...
1. Upload `The-Bar-Steward` folder to your `/wp-content/plugins/` directory  
2. Choose which plugin menus you want to hide by going to 'Settings > The Bar Steward'
...
= v1.2 =
* Added 'remove Social Metrics'
* Added 'remove Ultimate Security Checker'
* Simplified code
* Had a biscuit with my coffee
